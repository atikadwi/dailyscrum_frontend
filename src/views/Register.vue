                ...
                <form v-on:submit.prevent="Register" class="pt-3" method="post" action="#">
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input v-model = "text" type="text" class="form-control form-control-lg border-left-0" id="firstname" name="firstname" placeholder="First Name" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input v-model = "text" type="text" class="form-control form-control-lg border-left-0" id="lastname" name="lastname" placeholder="Last Name" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input v-model = "password" type="password" class="form-control form-control-lg border-left-0" name="password_verify" id="password_verify" placeholder="Retype Your New Password" required>                        
                    </div>
                  </div>
                  <div class="my-3">
